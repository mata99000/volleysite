                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('nickname')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'nickname') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'nickname') fa-sort-amount-up ml-2 @endif'></i> {{ __('Nickname') }} </th>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('dob')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'dob') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'dob') fa-sort-amount-up ml-2 @endif'></i> {{ __('Dob') }} </th>
